...
export async function generateMetadata({
  ...
  return buildMetadata({
    locale,
    title: seo?.title ? `${seo.title} · Home 2` : "Go Natural · Home 2",
...
export default async function Home2Page({
  ...
  return (
    <main
      data-route="home-2"
      className="font-body flex min-h-screen flex-col bg-brand-forest-black text-brand-warm-sand"
    >
      <HomeHero
        locale={locale}
      ...
      <BrandStatement
        text={h.brandStatement ?? t("story.title")}
        premiumOutdoorBranding
      />
