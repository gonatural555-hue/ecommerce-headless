  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="hero-display mt-6 max-w-4xl font-semibold tracking-tight text-white text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] [text-shadow:0_2px_28px_rgba(0,0,0,0.45)]">
          {title}
        </h1>
