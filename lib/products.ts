...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 235,
    category: "Cycling",
    images: ["/assets/images/products/gn-cycling-training-001/smart-bike-01.webp"],
    shortDescription:
  ...
  {
    id: "orz-rally-off-road-helmet",
    slug: "casco-off-road-orz-rally-antiparras",
    brand: "ORZ",
    title: "ORZ Rally Off-Road Helmet with Goggles",
    price: 145.26,
    category: "Active Sports",
    images: [],
    description:
      "Integral off-road helmet with ABS shell, EPS liner, ventilation, removable liner, and included goggles. Available on order via international fulfillment.",
    shortDescription:
      "Integral protection and ventilation for off-road riding. ORZ Rally combines an ABS outer shell, EPS inner layer, removable liner, and included goggles for motocross, enduro, and adventure.",
    longDescription: [
      "The ORZ Rally Off-Road Helmet is designed for motocross, enduro, and recreational riding on demanding terrain. Its structure combines an ABS outer shell with a shock-absorbing EPS inner layer in an integral full-face layout.",
      "The ventilation system distributes air intakes across the helmet to support airflow during activity. The breathable inner liner can be removed for cleaning and maintenance after each ride.",
      "The removable top visor lets you adapt the helmet setup, while the integral design provides front, side, rear, and chin coverage.",
      "Each helmet includes a complimentary pair of goggles to complete your off-road setup.",
      "Package contents: 1 ORZ Rally helmet, 1 removable top visor, 1 pair of complimentary goggles, removable inner liner included.",
      "Helmet care: remove the inner liner before cleaning; hand-wash the liner with mild soap; air-dry in the shade; wipe the shell with a damp cloth; do not use solvents, fuels, or abrasive products; do not expose to intense heat; inspect before each use; do not use after significant impact.",
      "Size guide: use a flexible tape measure around your head above the eyebrows and around the widest part at the back. Compare your measurement with the size chart. If your measurement falls exactly between two sizes, contact us before ordering.",
      "FAQ — Are goggles included? Yes. Each helmet includes a complimentary pair; design and tone may vary by model selected.",
      "FAQ — Which sizes are available? L, XL, and XXL.",
      "FAQ — Is there local stock? No. This item is sold on a dropshipping basis and is available on order.",
      "FAQ — Estimated delivery? The timeframe is shared during checkout. International fulfillment may vary due to customs, logistics, or external measures.",
      "FAQ — Do all models cost the same? Yes. All six models and three sizes are priced at ARS 209,900.",
      "The use of motorcycle equipment may be subject to local requirements. Check applicable conditions before use on public roads.",
    ],
    features: [
      "GOGGLES INCLUDED — complimentary goggles with every helmet",
      "Integral construction with ABS outer shell",
      "Shock-absorbing EPS inner layer",
      "Multi-point ventilation with lateral, front, and top intakes",
      "Removable, breathable, washable inner liner",
      "Removable top visor",
      "Extended front and chin coverage",
      "Six visual models available",
      "Sizes L, XL, and XXL",
      "Brand: ORZ · Model: Rally · Type: integral off-road helmet",
      "User: adult · Gender: unisex",
      "Approx. height: 27 cm · length with visor: 35 cm · width: 23.5 cm",
      "Approx. weight: 1.12 kg · Country of origin: China",
      "Package: helmet, removable top visor, complimentary goggles, removable liner",
    ],
    pdpTrust: {
      shippingEurope:
        "Available on order. This product is fulfilled via international shipping. Estimated delivery is shared at checkout and may change due to customs, inspections, logistics delays, strikes, or other external factors.",
      shippingLatam:
        "Available on order. International fulfillment — delivery timeframe confirmed during checkout.",
      returns:
        "See our returns policy for conditions that apply to made-to-order international items.",
    },
    translations: {
      es: {
        title: "Casco Off-Road ORZ Rally con Antiparras",
        description:
          "Casco integral off-road con carcasa ABS, capa EPS, ventilación, interior desmontable y antiparras incluidas. Disponible bajo pedido con envío internacional.",
        shortDescription:
          "Protección integral y ventilación para tus recorridos off-road. El casco ORZ Rally combina una carcasa exterior de ABS, capa interna de EPS, interior desmontable y antiparras incluidas en un diseño preparado para motocross, enduro y aventura.",
        longDescription: [
          "El Casco Off-Road ORZ Rally está diseñado para acompañar recorridos de motocross, enduro y conducción recreativa en terrenos exigentes. Su estructura combina una carcasa exterior de ABS con una capa interna amortiguadora de EPS, proporcionando una construcción integral y resistente.",
          "El sistema de ventilación distribuye entradas de aire en diferentes sectores del casco para favorecer la circulación durante la actividad. Su interior transpirable puede retirarse para facilitar la limpieza y el mantenimiento después de cada salida.",
          "La visera superior desmontable permite adaptar la configuración del casco, mientras que su diseño integral brinda cobertura frontal, lateral, posterior y en la zona del mentón.",
          "Cada casco incluye un par de antiparras de regalo para completar el equipo off-road.",
          "Contenido del paquete: 1 casco ORZ Rally, 1 visera superior desmontable, 1 par de antiparras de regalo, interior desmontable incorporado.",
          "Cuidado del casco: retirá el interior desmontable antes de limpiarlo; lavá el revestimiento interior a mano con agua y jabón suave; dejalo secar completamente a la sombra; limpiá la carcasa con un paño húmedo; no utilices solventes, combustibles ni productos abrasivos; no expongas el casco a fuentes intensas de calor; revisá su estado antes de cada uso; no lo utilices si presenta daños estructurales; después de un impacto importante, dejá de utilizarlo aunque no existan daños externos evidentes.",
          "Guía de talles: utilizá una cinta métrica flexible y medí el contorno de tu cabeza pasando la cinta por encima de las cejas y alrededor de la parte más ancha de la zona posterior. Compará el resultado con la tabla y elegí el talle correspondiente. Si la medida queda exactamente entre dos talles, consultanos antes de comprar.",
          "Pregunta frecuente — ¿Las antiparras están incluidas? Sí. Cada casco incluye un par de antiparras de regalo. El diseño y la tonalidad pueden depender del modelo seleccionado.",
          "Pregunta frecuente — ¿Qué talles están disponibles? L, XL y XXL.",
          "Pregunta frecuente — ¿Cómo elijo el talle correcto? Medí el contorno de tu cabeza y compará con la guía de talles.",
          "Pregunta frecuente — ¿El interior se puede retirar? Sí. El revestimiento interior es desmontable y puede lavarse.",
          "Pregunta frecuente — ¿La visera superior es desmontable? Sí.",
          "Pregunta frecuente — ¿El producto tiene ventilación? Sí. Incorpora múltiples entradas laterales, frontales y superiores.",
          "Pregunta frecuente — ¿Tiene stock local? No. Se comercializa bajo modalidad dropshipping y está disponible bajo pedido.",
          "Pregunta frecuente — ¿Cuánto demora la entrega? El plazo estimado se informa durante la compra y puede variar por cuestiones logísticas, aduaneras o gubernamentales.",
          "Pregunta frecuente — ¿Todos los modelos cuestan lo mismo? Sí. Los seis modelos y los tres talles tienen un precio de $209.900 ARS.",
          "Pregunta frecuente — ¿Puedo usarlo en la vía pública? El uso de equipamiento para motocicleta puede estar sujeto a requisitos locales. Verificá las condiciones aplicables antes de utilizarlo en la vía pública.",
        ],
        features: [
          "ANTIPARRAS INCLUIDAS — recibí el casco junto con un par de antiparras para completar tu equipo off-road",
          "Construcción integral con carcasa exterior de ABS",
          "Capa interna amortiguadora de EPS",
          "Sistema de ventilación con múltiples entradas de aire",
          "Interior transpirable, desmontable y lavable",
          "Visera superior desmontable",
          "Cobertura extendida en la zona frontal y del mentón",
          "Seis alternativas visuales",
          "Talles L, XL y XXL",
          "Marca: ORZ · Modelo: Rally · Tipo: casco integral off-road",
          "Usuario: adulto · Género: unisex",
          "Alto aprox.: 27 cm · Largo aprox. con visera: 35 cm · Ancho aprox.: 23,5 cm",
          "Peso aprox.: 1,12 kg · País de origen: China",
          "Contenido: casco, visera superior desmontable, antiparras de regalo, interior desmontable",
        ],
        seo: {
          title: "Casco Off-Road ORZ Rally con Antiparras | Go Natural",
          description:
            "Casco integral ORZ Rally con carcasa ABS, interior EPS, ventilación, revestimiento desmontable y antiparras incluidas. Disponible en talles L a XXL.",
        },
      },
    },
    variants: [
      ...
      },
      {
        ...
        default: "l",
        options: [
          { value: "l", label: "L (57–58 cm)", priceModifier: 0 },
          { value: "xl", label: "XL (59–60 cm)", priceModifier: 0 },
          { value: "xxl", label: "XXL (61–62 cm)", priceModifier: 0 },
        ],
      },
    ],
  },
